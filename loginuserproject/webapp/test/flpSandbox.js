		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "loginuserproject",
									"targetURL": "#loginuserproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"loginuserproject-display": {
								"semanticObject": "loginuserproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=loginuserproject",
									"url": sap.ui.require.toUrl("loginuserproject")
								}
							}
						}
					}
